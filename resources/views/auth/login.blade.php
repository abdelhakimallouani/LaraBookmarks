...
<body class="bg-odin min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-[500px] bg-white rounded-2xl shadow-xl shadow-blue-100/50 p-10 border border-white">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 font-medium text-sm">Manage your digital life with clarity.</p>
        </div>
        ...
        <div class="bg-gray-100/80 p-1.5 rounded-2xl flex mb-8">
            ...
            <a href="{{ route('register.form') }}" class="flex-1 py-2.5 text-center text-sm font-bold rounded-xl text-gray-400 hover:text-gray-600 transition">
                Register
            </a>
        </div>
