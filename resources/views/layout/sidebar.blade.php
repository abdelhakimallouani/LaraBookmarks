<aside class="w-64 bg-white border-r border-gray-100 flex flex-col justify-between py-8 px-6 h-screen sticky top-0 shrink-0">
    <div>
        ...
        <nav class="space-y-1">
            <a href="{{ route('dashboard') }}" class="flex items-center gap-4 px-4 py-3 {{ request()->is('dashboard') ? 'bg-[#e0f2fe] text-[#0ea5e9]' : 'text-gray-500 hover:bg-gray-50' }} rounded-xl font-bold transition">
