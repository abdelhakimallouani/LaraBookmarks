...
<head>
    ...
    <title>Odin - Update Category</title>
        ...
        <main class="flex-1 p-12 flex justify-center items-start">
            ...
            <div class="w-full max-w-2xl">
                ...
                <header class="mb-10 flex flex-col justify-center items-center gap-2">
                    <h2 class="text-3xl font-extrabold text-[#1e293b] mb-1">Update Category</h2>
                    <p class="text-gray-400 font-medium">Modify the details of your logical group.</p>
                </header>
                    ...
                    <form action="{{ route('categories.update', $category->id) }}" method="POST">
                        ...
                        @method('PUT') <div class="mb-8">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="name" name="name" value="{{ $category->name }}" placeholder="e.g. Design, Development..." required
